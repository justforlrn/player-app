...
public static class WebActiveHealthyKidsVietNamEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE WebActiveHealthyKidsVietNamModuleExtensionConfigurator CLASS (in the Domain.Shared project)
