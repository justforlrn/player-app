...
export class RestaurantComponent {
  ...
  @ViewChild('drawerTemplate', { static: false }) drawerTemplate?:
    TemplateRef<{
      $implicit: { value: string };
      drawerRef: TDSDrawerRef<string>;
    }>;

  @ViewChild('drawerFooter', { static: false }) drawerFooter?:
    TemplateRef<{}>;

  @ViewChild('drawerTotalTemplate', { static: false }) drawerTotalTemplate?:
    TemplateRef<{
      $implicit: { value: string };
      drawerRef: TDSDrawerRef<string>;
    }>;

  @ViewChild('drawerTotalFooter', { static: false }) drawerTotalFooter?:
    TemplateRef<{}>;
  constructor(
  ...
  // getValueItem(data: TDSSafeAny){
  //   this.restaurantService.getValueItem(data)
  // }
